        ...
        return (
          ...
          >
            ...
            >
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-[var(--rc-brand)]/10 border border-[var(--rc-brand)]/15 flex items-center justify-center mb-6">
              ...
              {/* Back */}
              <div
                className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[var(--rc-brand)] to-[#ff6b35] p-8 flex flex-col items-center justify-center text-center"
...
function ParallaxCard({ feature, index }: { feature: typeof features[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute w-40 h-40 rounded-full bg-[var(--rc-brand)]/10 blur-[60px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
      </motion.div>
      ...
      >
        <div className="inline-flex items-center gap-2 mb-3">
          <div className="w-8 h-8 rounded-lg bg-[var(--rc-brand)]/15 flex items-center justify-center">
            <feature.icon size={14} className="text-[var(--rc-brand)]" />
          </div>
          <span className="text-[10px] tracking-[0.2em] text-[var(--rc-brand)]/60 uppercase">{feature.tag}</span>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 p-8">
        <div className="w-12 h-12 rounded-xl bg-[var(--rc-brand)]/10 border border-[var(--rc-brand)]/10 flex items-center justify-center mb-6" style={{ transform: "translateZ(30px)" }}>
          <feature.icon size={22} className="text-[var(--rc-brand)]" />
        </div>
        ...
        return (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[var(--rc-brand)] to-[#ff6b35] z-0"
            />
            ...
            >
              <svg viewBox="0 0 400 20" className="w-full h-full" preserveAspectRatio="none">
                <path
                  ...
                  fill={hovered ? "var(--rc-brand)" : "transparent"}
            ...
            <div className="relative z-10 p-8">
              <div className="w-12 h-12 rounded-xl bg-[var(--rc-brand)]/10 group-hover:bg-white/20 border border-[var(--rc-brand)]/10 group-hover:border-white/20 flex items-center justify-center mb-6 transition-colors duration-500">
                <f.icon size={22} className="text-[var(--rc-brand)] group-hover:text-white transition-colors duration-500" />
              </div>
              <h3 className="text-xl font-bold text-white mb-3">{f.title}</h3>
...
function Card5() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {features.map((f, i) => (
        <MagneticCard key={i}>
          <div className="group p-8 rounded-2xl bg-[#0c0c0c] border border-white/[0.05] hover:border-[var(--rc-brand)]/20 transition-colors duration-300">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[var(--rc-brand)] to-[#ff6b35] flex items-center justify-center group-hover:shadow-[0_0_25px_rgba(255,69,0,0.3)] transition-shadow duration-500">
                <f.icon size={18} className="text-white" />
              </div>
              <span className="text-xs text-[var(--rc-brand)]/40 tracking-[0.2em] uppercase">{f.tag}</span>
            </div>
            <h3 className="text-xl font-bold text-white mb-3">{f.title}</h3>
      ...
      {features.map((f, i) => (
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}
            className="absolute inset-0 rounded-2xl bg-[#111] border border-white/[0.06] p-8 flex flex-col z-20 hover:border-[var(--rc-brand)]/20 transition-colors duration-300"
          >
            <div className="w-12 h-12 rounded-xl bg-[var(--rc-brand)]/10 border border-[var(--rc-brand)]/15 flex items-center justify-center mb-6">
            ...
            <AnimatePresence>
              {hovered && [0, 1, 2].map((ring) => (
                <motion.div
                  ...
                  className="absolute top-8 left-8 w-14 h-14 rounded-full border border-[var(--rc-brand)]/30 pointer-events-none"
                />
              ))}
            </AnimatePresence>

            <div className="relative z-10">
              <div className="w-14 h-14 rounded-full bg-[var(--rc-brand)]/10 border border-[var(--rc-brand)]/15 flex items-center justify-center mb-6 group-hover:bg-[var(--rc-brand)]/20 transition-colors">
                <f.icon size={22} className="text-[var(--rc-brand)]" />
              </div>
              <h3 className="text-xl font-bold text-white mb-3">{f.title}</h3>
              <p className="text-white/40 text-sm leading-relaxed">{f.description}</p>
      ...
      {features.map((f, i) => {
        ...
        return (
          ...
          >
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[var(--rc-brand)]/20 to-[var(--rc-brand)]/5 flex items-center justify-center mb-5">
            ...
            <motion.div
              ...
              transition={{ duration: 0.35, ease: [0.22, 1, 0.36, 1] }}
              className="absolute inset-0 p-8 flex flex-col justify-center bg-gradient-to-t from-[var(--rc-brand)]/10 to-[#0c0c0c]"
            >
              <div className="w-10 h-10 rounded-lg bg-[var(--rc-brand)]/15 flex items-center justify-center mb-4">
                <f.icon size={18} className="text-[var(--rc-brand)]" />
              </div>
              <h3 className="text-xl font-bold text-white mb-3">{f.title}</h3>
              <p className="text-white/50 text-sm leading-relaxed">{f.description}</p>
              <div className="mt-4 flex items-center gap-1.5 text-[var(--rc-brand)] text-xs font-medium">
        ...
        return (
          ...
          >
              ...
              {hovered && (
                <>
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-2xl bg-[var(--rc-brand)]/5 z-0"
                  />
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{
                    ...
                    className="absolute inset-0 border border-[var(--rc-brand)]/30 rounded-2xl z-0"
            ...
            <motion.div
              ...
              className="absolute inset-0 rounded-2xl border border-[var(--rc-brand)]/25 z-0"
            />

            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                <f.icon size={24} className="text-[var(--rc-brand)]" />
                <div className="h-px flex-1 bg-white/[0.04] group-hover:bg-[var(--rc-brand)]/20 transition-colors duration-700" />
                <span className="font-mono text-xs text-white/20 group-hover:text-[var(--rc-brand)]/50 transition-colors">0{i + 1}</span>
              </div>
              <h3 className="text-xl font-bold text-white mb-3">{f.title}</h3>
              <p className="text-white/40 text-sm leading-relaxed">{f.description}</p>
            </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {features.map((f, i) => {
        ...
        return (
          <div
            key={i}
            className="group relative p-8 rounded-2xl bg-[#0a0a0a] border border-white/[0.05] hover:border-[var(--rc-brand)]/15 overflow-visible cursor-default transition-colors duration-500"
            onMouseEnter={() => setHovered(true)}
            onMouseLeave={() => setHovered(false)}
          >
            {/* Orbiting dot */}
            ...
            >
              <div className="absolute top-[-3px] left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-[var(--rc-brand)] shadow-[0_0_12px_rgba(255,69,0,0.6)]" />
            </motion.div>

            {/* Dashed border that appears on hover */}
            <motion.div
              animate={{ opacity: hovered ? 0.3 : 0 }}
              className="absolute inset-[-6px] rounded-[20px] border border-dashed border-[var(--rc-brand)]/30 pointer-events-none"
            />

            <div className="relative z-10">
              <div className="w-12 h-12 rounded-xl bg-[var(--rc-brand)]/10 border border-[var(--rc-brand)]/10 flex items-center justify-center mb-6">
                <f.icon size={22} className="text-[var(--rc-brand)]" />
              </div>
              <h3 className="text-xl font-bold text-white mb-3">{f.title}</h3>
              <p className="text-white/40 text-sm leading-relaxed">{f.description}</p>
